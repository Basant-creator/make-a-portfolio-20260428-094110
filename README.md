...
Make a portfolio for a senior fullstack developer with 5 year of experience and his main projects are WebApp for ordering food from local vendors and another project with Exam platform who worked in Amazon for 3 year
...
| `css/projects.css**` | A supporting project file. |
| `css/style.css**` | A supporting project file. |
| `index.html**` | A supporting project file. |
| `js/filter.js**` | A supporting project file. |
| `js/projects.js**` | A supporting project file. |
| `js/script.js**` | A supporting project file. |
| `project-detail.html**` | A supporting project file. |
| `projects.html**` | A supporting project file. |
